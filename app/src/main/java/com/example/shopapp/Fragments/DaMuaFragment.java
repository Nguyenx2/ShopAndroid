 ...
 * Use the {@link DaMuaFragment#newInstance} factory method to
...
public class DaMuaFragment extends Fragment {
    ...
    public static DaMuaFragment newInstance(String param1, String param2) {
        DaMuaFragment fragment = new DaMuaFragment();
